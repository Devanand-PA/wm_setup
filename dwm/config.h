...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,	        XK_m, 				spawn,          {.v = (const char*[]){"chromium",NULL} } },
	{ MODKEY,	                XK_m, 				spawn,          {.v = (const char*[]){"thunderbird",NULL} } },
	{ MODKEY|Mod1Mask,	        XK_m, 				spawn,          {.v = (const char*[]){"flatpak","run","one.ablaze.floorp","-P","Manga",NULL} } },
...
//	{ MODKEY,			XK_r,   			quit,           {1} }, 
	...
	{ MODKEY,	                XK_b, 				spawn,          {.v = (const char*[]){"flatpak","run","one.ablaze.floorp","-P","default-release",NULL} } },
