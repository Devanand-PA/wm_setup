...
fun! s:register_default_theme()
  ...
  let s:themes['default'] = {
        ...
        \    }
        \ }
source ~/.config/nvim/colors/colors-wal.vim
" Theme can have 'light' and/or 'dark' color palette.
  ...
  let s:themes['default'].dark = {
        ...
        \     'TEST_256_COLOR_CONSISTENCY' : 1,
        \     'palette' : {
        \       'color00' : [g:color0, '234'],
        \       'color01' : [g:color1, '125'],
        \       'color02' : [g:color2, '70'],
        \       'color03' : [g:color3, '179'],
        \       'color04' : [g:color4, '74'],
        \       'color05' : [g:color5, '244'],
        \       'color06' : [g:color6, '173'],
        \       'color07' : [g:color7, '252'],
        \       'color08' : [g:color8, '240'],
        \       'color09' : [g:color9, '71'],
        \       'color10' : [g:color10, '148'],
        \       'color11' : [g:color11, '140'],
        \       'color12' : [g:color12, '214'],
        \       'color13' : [g:color13, '205'],
        \       'color14' : [g:color14, '37'],
        \       'color15' : [g:color15, '66'],
        \       'color16' : ['#5fafd7', '74'],
        \       'color17' : ['#d7af00', '178'],
