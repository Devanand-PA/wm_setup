...
alias tt='gcal && date && cat $HOME/Documents/Courses/timetable.txt'
alias todo='vi $HOME/.scripts/todo/todo.md && clear && cat $HOME/.scripts/todo/todo.md'
